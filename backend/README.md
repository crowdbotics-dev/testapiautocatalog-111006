...
## Project Structure
    ...
    ├── testapiautocatalog_111006  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_111006`
...
2. Clone this repo and `cd testapiautocatalog_111006`
